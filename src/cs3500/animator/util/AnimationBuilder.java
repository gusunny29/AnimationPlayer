...
/**
 * Interface that Converts the created model to the originally interpreted model.
 * Uses the builder pattern in order to construct the necessary model.
 * @param <Doc> The generic type of conversion
 */
