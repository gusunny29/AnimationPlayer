...
/**
 * A class whose purpose is to test the EditView class. Tests the actionListeners of the class
 */
public class EditViewTest {
  ...
  List<AbstractShape> smallDemoShapes = new ArrayList<AbstractShape>(Arrays.asList(
          redRectangle, blueEllipse));

  IVisualView example = new EditView(new VAView());
  ...
  @Test
  public void testGetShapeClicked() {

    assertEquals(redRectangle, example.getShapeClicked(smallDemoShapes, new Posn(200, 200)));
  }

  @Test
  public void testGetShapeClickedBlueEllipse() {

    assertEquals(redRectangle, example.getShapeClicked(smallDemoShapes, new Posn(210, 219)));
  }
}